package hackaton.interventure.com.interventurehackaton.detail.video
...
class VideoDetailFragment : DetailsFragment() {

    override fun getDetailActivityIntent(): Intent {
        return Intent(activity, VideoDetailActivity::class.java)
    }
